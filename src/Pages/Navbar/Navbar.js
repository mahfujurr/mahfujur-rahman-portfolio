		...
		<>
			<div className='sticky flex justify-center pt-5 font-semibold '>
				<div className='flex px-2 md:px-10 py-5 text-white rounded-full bg-green-200/10'>
					<Link
						to='/'
						className='flex flex-col items-center justify-center mx-1 lg:mx-2 hover:text-green-400'>
					...
					<a
						...
						target='_blank'
						className='flex flex-col items-center justify-center mx-1 lg:mx-2 hover:text-green-400' rel="noreferrer">
						<DocumentIcon className='w-6 h-6 text-white hover:text-green-400' />
						<h1 className='text-sm '>Resume</h1>
					</a>
					<Link
						to='projects'
						className='flex test2 flex-col items-center justify-center mx-1 lg:mx-2 hover:text-green-400'>
